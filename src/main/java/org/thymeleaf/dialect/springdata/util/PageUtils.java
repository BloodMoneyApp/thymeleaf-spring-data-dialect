...
public final class PageUtils {
    ...
    public static Page<?> findPage(final ITemplateContext context) {
        ...
        if (context instanceof IWebContext) {
            IWebRequest request = ((IWebContext) context).getExchange().getRequest();
            Set<String> attrNames = request.getAllParameterNames(); // .getAttributeNames();
            Page<?> pageOnRequest = null;
            while (attrNames.iterator().hasNext()) {
                String attrName = (String) attrNames.iterator().next();
                Object attr = request.getParameterValue(attrName);
    ...
    private static String buildBaseUrl(final ITemplateContext context, Collection<String> excludeParams) {
        ...
        if (url == null && context instanceof IWebContext) {
            ...
            final IWebRequest request = webContext.getExchange().getRequest();
